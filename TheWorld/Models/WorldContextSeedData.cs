...
namespace TheWorld.Models
{
    public class WorldContextSeedData
    {
        ...
        {
            if (await _userManager.FindByEmailAsync("one@one.com") == null)
            {
            ...
            _context.Trips.Add(firstTrip);

            _context.Stops.AddRange(firstTrip.Stops);
            ...
            _context.Trips.Add(secondTrip);

            _context.Stops.AddRange(secondTrip.Stops);
